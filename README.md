...
- AstraZeneca_OriginalDataset_FinalCode.py
	Uses the original AstraZeneca–Sanger Excel-based dataset, consisting of:
	- Astrazeneca_Main.xlsx
	- CellLineName.xlsx
	- All_mutations.xlsx
	- drug_smiles.csv
	- Drugname_Pathway.xlsx
...
- astrazeneca_enhanceddataset_finalcode.py
	...
	- all_synergy_summary.csv
	- all_synergy_per_concentration.csv
	- Drug_info_release.csv
	- drug_smiles.csv
	- Drugname_Pathway.xlsx 
...
The enhanced script also includes:
- Automatic saving of training histories
- Generation of metric plots and comparison bar charts
- Construction of a final processed dataset used for downstream analysis and visualization
...
- To reproduce the results exactly as in our project:

	- Download “AstraZeneca_ALLFILES_NEW”
	
	This folder contains all files required for the original dataset script.
	
	- Download “Updated_Astrazeneca”
	
	This folder contains all files required for the enhanced dataset script, including the synergy summary files.

Place each folder inside Google Drive and update the paths in the scripts accordingly.
